...
export const rules: ChessRule[] = [
  ...
  },
  {
    ...
    title: "Checkmate",
    shortDescription:
      "The King is in check with no legal escape — the game ends.",
    difficulty: "beginner",
    icon: "👑",
    content: [
    ...
    examples: [
      {
        id: "en-passant-ex-1",
        caption:
          "The pawn captures diagonally onto the square the enemy pawn passed over.",
        from: { file: 3, rank: 4 },
        to: [{ file: 4, rank: 5 }],
  ...
  },
  {
    ...
    shortDescription:
      "A pawn reaching the final rank becomes a stronger piece.",
    difficulty: "beginner",
    icon: "⭐",
    content: [
